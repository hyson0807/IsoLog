/**
 * Google Custom Search API로 Accutane 관련 콘텐츠를 수집하여 DynamoDB에 저장
 * (날짜 제한 없이 오래된 콘텐츠도 수집)
 *
 * 사용법:
...
// 검색 키워드 (Accutane 관련 - 영어 중심)
const ARTICLE_KEYWORDS = [
  { keyword: "accutane dose", language: "en" },
  { keyword: "accutane dosage", language: "en" },
  { keyword: "accutane side effects", language: "en" },
  { keyword: "accutane journey", language: "en" },
  { keyword: "accutane before after", language: "en" },
  { keyword: "accutane tips", language: "en" },
  { keyword: "isotretinoin dose", language: "en" },
  { keyword: "isotretinoin experience", language: "en" },
];

// 소셜 미디어 검색 키워드
const SOCIAL_KEYWORDS = [
  { keyword: "accutane journey site:youtube.com", language: "en" },
  { keyword: "accutane before after site:youtube.com", language: "en" },
  { keyword: "isotretinoin experience site:youtube.com", language: "en" },
];
...
// Google Custom Search API 호출 (날짜 제한 없음)
async function searchGoogle(
  ...
  // 날짜 제한 없음 (dateRestrict 제거)
  let url = `https://www.googleapis.com/customsearch/v1?key=${GOOGLE_API_KEY}&cx=${GOOGLE_CX}&q=${encodeURIComponent(keyword)}&num=10&start=${start}`;
...
// 메인 함수
async function main() {
  console.log("🚀 Accutane 아카이브 콘텐츠 수집 시작 (날짜 제한 없음)\n");
